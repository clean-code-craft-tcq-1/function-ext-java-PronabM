...
public enum MonitorStates {
	...
	BREACH("BREACH:: ", "BRUCH:: "),
	IS_ABOVE_ALLOWED_LIMIT(" is above the allowed limit.", " liegt über dem zulässigen Grenzwert."),
	IS_BELOW_ALLOWED_LIMIT(" is below the allowed limit.", " liegt unter dem zulässigen Grenzwert."),
